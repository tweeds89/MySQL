...
if ($result === TRUE) {
    echo "Tabela orders została stworzona poprawnie <br>";
} else {
    echo "Tabela orders nie została stworzona: ". $conn->error;
}
...
$sql = "INSERT INTO orders (customer_id, order_details) VALUES (1, 'dostawa do domu'),
        (2, 'płatność gotówką'), (1, 'płatność kartą'), (3, 'odbiór osobisty'),
        (3, 'przedłużona gwarancja')";

$result = $conn->query($sql);
    if($result){
        echo "Dane do tabeli orders zostały wpisane <br>";
    }
